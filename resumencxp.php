    ...
    <section class="content">
        ...
        <div class="card ">
            <div class="card-header bg-green">
                <h4 class="card-title text-center">RESUMEN DE EGRESOS</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive">
                                <table name="tablaV" id="tablaV" class="table table-sm table-striped borderless table-hover table-bordered table-condensed text-nowrap w-auto mx-auto" style="width:100%">
